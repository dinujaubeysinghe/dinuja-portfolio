...
const About = () => {
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-end mt-36 px-4 md:px-6">
      <img src={aboutBg} alt="Background" className="absolute top-0 left-0 w-full h-full object-cover opacity-10 pointer-events-none" />
      <h2 className="text-3xl font-main font-bold md:text-7xl  mb-8 md:mb-16 pb-30 animate-fadeUp" style={{animationDelay: '150ms'}}>
          About Me
        </h2>
       
    </div>
    {/* About */}
      <section className=' w-full h-auto pb-24 px-4 md:px-6 mx-auto animate-pop' style={{animationDelay: '220ms'}}>
        <motion.div
        ...
        >
         <div className='text-white font-main font-bold text-3xl px-88 animate-fadeUp' style={{animationDelay: '300ms'}}>
           Ayubowan<span className='text-white/70 font-sans'>..</span> 
         </div>
          <div className='text-white font-main px-88 mt-4 text-md'>
          ...
          <div className='text-white/70 font-main px-88 mt-4 text-sm flex items-center gap-3'>
            <span className='inline-block line-grow' style={{animationDelay: '620ms'}}></span>
            <span className='italic animate-fadeUp' style={{animationDelay: '700ms'}}>Dinuja Ubeysinghe</span>
          </div>
        </motion.div>
      </section>
    </div>
