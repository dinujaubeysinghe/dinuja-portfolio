      ...
      <div className="flex flex-col items-center mt-30 px-4 md:px-6 ">
        ...
        >
          <a
            ...
            className="flex items-center gap-2 text-sm font-main font-medium text-white/80 hover:text-white border border-white/20 hover:border-white/50 hover:bg-white/5 px-4 py-2 rounded-full transition-all duration-200"
          >
          ...
          {project.live ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm font-main font-medium text-white border border-white/50 hover:border-white px-4 py-2 rounded-full transition-all duration-200 hover:bg-white/5"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-main font-medium text-white border border-white/50 hover:border-white px-4 py-2 rounded-full transition-all duration-200 cursor-pointer hover:bg-white/5"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/>
                <polyline points="15 3 21 3 21 9"/>
